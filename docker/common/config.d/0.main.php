...
return [
    'app.siteName' => 'Mapa Cultural de Aracaju',
    'app.siteDescription' => 'O Mapa Cultural é uma plataforma colaborativa que reúne informações sobre agentes, espaços, eventos, projetos culturais e editais',
    
    // Define o tema ativo no site principal. Deve ser informado o namespace do tema e neste deve existir uma classe Theme.
    'themes.active' => 'Funcaju',
